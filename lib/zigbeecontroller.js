...
class ZigbeeController extends EventEmitter {
    ...
    */
    ...
    handleReady() {
        ...
        devices.forEach(device => {
            if (device.manufId === 4151 || device.manufId === 4447) {
                this.shepherd
                    .find(device.ieeeAddr, device.epList[0])
                    .getDevice()
                    .update({
                         status: 'online',
    ...
    forceRemove(deviceID, callback) {
        ...
        // force
        return this.shepherd._unregisterDev(device, (err, result) => callback(err, result));
    }
    ...
    handleMessage(message) {
        ...
        switch (message.type) {
            ...
            case 'devLeaving':
                ...
                break;
            default:
                // We don't handle messages without endpoints.
                ...
                this.event(message.type, device.ieeeAddr, message, {
                    ...
                    modelId: cutZeros(device.modelId),
                });
        }
    }
