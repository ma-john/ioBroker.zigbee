...
const devices = [{
    ...
    {
        vendor: 'Xiaomi',
        models: ['lumi.sensor_switch.aq2', 'lumi.remote.b1acn01', 'lumi.remote.b1acn01\u0000\u0000\u0000\u0000\u0000\u0000'],
        icon: 'img/aqara.switch.png',
        states: [states.click, states.double_click, states.triple_click, states.quad_click, states.voltage, states.battery],
    },
    {
        vendor: 'Xiaomi',
    ...
    {
        vendor: 'Xiaomi',
        models: ['lumi.sensor_86sw1\u0000lu', 'lumi.sensor_86sw1lu', 'lumi.remote.b186acn01', 'lumi.remote.b186acn01\u0000\u0000\u0000'],
        icon: 'img/86sw1.png',
        states: [states.click, states.voltage, states.battery],
    },
    {
        vendor: 'Xiaomi',
        models: ['lumi.sensor_86sw2\u0000Un', 'lumi.sensor_86sw2Un', 'lumi.sensor_86sw2.es1', 'lumi.remote.b286acn01', 'lumi.remote.b286acn01\u0000\u0000\u0000'],
        icon: 'img/86sw2.png',
